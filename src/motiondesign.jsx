...
const tagColors = {
  ...
  Intro: 'bg-orange-100 dark:bg-orange-900 text-orange-600 dark:text-orange-300',
  Packaging: 'bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300',
  "3D": 'bg-pink-100 dark:bg-pink-900 text-pink-600 dark:text-pink-200',
  Ads: 'bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-200',
}
  ...
  return (
    <div className="px-8 md:px-14 bg-stone-50 transition-colors duration-300 ease-in-out dark:bg-stone-950">
      <section className="mb-8 md:mb-12">
        <p className="md:text-[16rem] text-6xl tracking-tight font-bold text-black dark:text-white">Motion Design</p>
      </section>
